module.exports = function (e) {
    ...
    var u = function () {};
    if (l.debuglog ? u = l.debuglog("gfs4") : /\bgfs4\b/i.test(process.env.NODE_DEBUG || "") && (u = function () {
    ...
    function h(e) {
        s(e), e.gracefulify = h, e.createReadStream = function (t, n) {
        ...
        if (e.readdir = function (e, t, n) {
                ...
                return r.push((function (e, t) {
                    t && t.sort && t.sort();
                    !e || "EMFILE" !== e.code && "ENFILE" !== e.code ? ("function" == typeof n && n.apply(this, arguments), d()) : p([o, [r]])
                })), o(r)
    ...
    e.exports = h(c(o)), process.env.TEST_GRACEFUL_FS_GLOBAL_PATCH && !o.__patched && (e.exports = h(o), o.__patched = !0)
}, function (e, t) {
    e.exports = require("fs")
}, function (e, t, n) {
    "use strict";
    e.exports = Object.assign({}, n(33), n(35), n(39), n(90), n(92), n(98), n(6), n(104), n(105), n(106), n(8), n(21));
    const r = n(3);
    ...
    var i = n(12);
    r.hash = i.hash, r.clone = i.clone, r.longestElement = i.longestElement, r.exception = n(32), r.config = n(26), r.addColors = r.config.addColors, r.Container = n(81).Container, r.Logger = n(82).Logger, r.Transport = n(16).Transport, r.loggers = new r.Container;
    var o = new r.Logger({
    ...
    t.setLevels = function (e, n, r, i) {
        return n && Object.keys(n).forEach((function (t) {
            delete e[t]
        })), e.levels = r || l.npm.levels, e.padLevels && (e.levelLength = t.longestElement(Object.keys(e.levels))), Object.keys(e.levels).forEach((function (t) {
        ...
        if (e.json || !0 === e.logstash) {
            if ("object" != typeof c && null != c && (c = {
                ...
                var u = {};
                void 0 !== n.message && (u["@message"] = n.message, delete n.message), void 0 !== n.timestamp && (u["@timestamp"] = n.timestamp, delete n.timestamp), u["@fields"] = t.clone(n), n = u
            }
        ...
        if (n = s ? s + " - " : "", a && (n += "all" === e.colorize || "level" === e.colorize || !0 === e.colorize ? l.colorize(e.level) : e.level), n += e.align ? "\t" : "", n += s || a ? ": " : "", n += e.label ? "[" + e.label + "] " : "", n += "all" === e.colorize || "message" === e.colorize ? l.colorize(e.level, e.message) : e.message, null != c)
        ...
        return -1 === e.start && delete e.start, i.readable = !0, i.destroy = function () {
            ...
            ! function a() {
                if (!i.destroyed) return s.read(c, n, 0, n.length, l, (function (s, c) {
                    if (s) return t ? t(s) : i.emit("error", s), void i.destroy();
                    if (!c) return o && ((null == e.start || u > e.start) && (t ? t(null, o) : i.emit("line", o)), u++, o = ""), setTimeout(a, 1e3);
                    var f = r.write(n.slice(0, c));
                    t || i.emit("data", f);
                    for (var h = (f = (o + f).split(/\n+/)).length - 1, p = 0; p < h; p++)(null == e.start || u > e.start) && (t ? t(null, f[p]) : i.emit("line", f[p])), u++;
                    return o = f[h], l += c, a()
                }));
                s.close(c)
            }()
    ...
    r.supportsColor = n(63), void 0 === r.enabled && (r.enabled = r.supportsColor), r.stripColors = r.strip = function (e) {
    ...
    var c, l = (c = {}, i.grey = i.gray, Object.keys(i).forEach((function (e) {
    ...
    for (var d in r.trap = n(65), r.zalgo = n(66), r.maps = {}, r.maps.america = n(67), r.maps.zebra = n(68), r.maps.rainbow = n(69), r.maps.random = n(70), r.maps) ! function (e) {
        r[e] = function (t) {
            return p(r.maps[e], t)
        }
    }(d);
    ...
    function s(e) {
        ...
        for (var s, a = t.isAbsolute(n), c = n.split(/\/+/), l = 0, u = c.length - 1; u >= 0; u--) "." === (s = c[u]) ? c.splice(u, 1) : ".." === s ? l++ : l > 0 && ("" === s ? (c.splice(u + 1, l), l = 0) : (c.splice(u, 2), l--));
    ...
    (function () {
        t.Emitter = n(116), t.Disposable = n(29), t.CompositeDisposable = n(117)
    }).call(this)
}, function (e, t) {
    ...
    i.addColors = function (e) {
        ...
        return n
    }, i.cli = n(71), i.npm = n(72), i.syslog = n(73), i.addColors(i.cli.colors), i.addColors(i.npm.colors), i.addColors(i.syslog.colors)
}, function (e, t) {
    ...
    ! function () {
                ...
                return function (t, n, r) {
                    ...
                    ! function l() {
                        ...
                        for (; c < e && a < o;) {
                            ...
                            var u = i[(a += 1) - 1];
                            n(t[u], u, (function (e) {
                                e ? (r(e), r = function () {}) : (c -= 1, (s += 1) >= o ? r() : l())
                            }))
                        }
                    }()
                }
        ...
        o.map = y(w), o.mapSeries = v(w), o.mapLimit = function (e, t, n, r) {
            return b(t)(e, n, r)
        };
        var b = function (e) {
            return function (e, t) {
        ...
        o.filter = y(_), o.filterSeries = v(_), o.select = o.filter, o.selectSeries = o.filterSeries;
        ...
        o.detect = y(S), o.detectSeries = v(S), o.some = function (e, t, n) {
            ...
            c((function () {
                ...
                for (var r, h = u(e[n]) ? e[n] : [e[n]], m = function (e) {
                        var r = d(arguments, 1);
                    ...
                    }, g = h.slice(0, Math.abs(h.length - 1)) || [], y = g.length; y--;) {
                    if (!(r = e[g[y]])) throw new Error("Has inexistant dependency");
                    if (u(r) && ~r.indexOf(n)) throw new Error("Has cyclic dependencies")
                }
                var v = function () {
                    return e = function (e, t) {
                        return e && i.hasOwnProperty(t)
                    }, t = !0, f(g, (function (n, r, i) {
                        t = e(t, n, r, i)
        ...
        var x = function (e, t, n) {
            if (n = n || s, u(t)) e.map(t, (function (e, t) {
                e && e((function (e) {
                    var n = d(arguments, 1);
        ...
        o.parallel = function (e, t) {
            ...
            if (t = t || s, u(e)) o.mapSeries(e, (function (e, t) {
                e && e((function (e) {
                    var n = d(arguments, 1);
                    n.length <= 1 && (n = n[0]), t.call(null, e, n)
                }))
        ...
        o.concat = y(C), o.concatSeries = v(C), o.whilst = function (e, t, n) {
            e() ? t((function (r) {
                if (r) return n(r);
                o.whilst(e, t, n)
            })) : n()
            ...
            function n(e, t, n, r) {
                if (e.started || (e.started = !0), u(t) || (t = [t]), 0 === t.length) return o.setImmediate((function () {
                    e.drain && e.drain()
                }));
                f(t, (function (t) {
                    var i = {
        ...
        o.log = O("log"), o.dir = O("dir"), o.memoize = function (e, t) {
            var n = {},
                r = {};
            t = t || function (e) {
                return e
        ...
        o.applyEach = y(k), o.applyEachSeries = v(k), o.forever = function (e, t) {
            ! function n(r) {
                if (r) {
                    if (t) return t(r);
                    throw r
    ...
    a.prototype._version = 3, a.fromSourceMap = function (e) {
        ...
        for (var e, t, n, o, s = 0, a = 1, c = 0, l = 0, u = 0, f = 0, h = "", p = this._mappings.toArray(), d = 0, m = p.length; d < m; d++) {
            ...
            e += r.encode(t.generatedColumn - s), s = t.generatedColumn, null != t.source && (o = this._sources.indexOf(t.source), e += r.encode(o - f), f = o, e += r.encode(t.originalLine - 1 - l), l = t.originalLine - 1, e += r.encode(t.originalColumn - c), c = t.originalColumn, null != t.name && (n = this._names.indexOf(t.name), e += r.encode(n - u), u = n)), h += e
        }
        return h
    ...
    var r, i = n(108).SourceMapConsumer,
        o = n(1);
    try {
    ...
    function S(e) {
        ...
        }(o), (e = E(e)).getEvalOrigin = function () {
            return o
        }, e) : e
    }

    function x(e, t) {
        return c && (u = {}, f = {}), e + t.map((function (e) {
            return "\n    at " + S(e)
        })).join("")
    }
    ...
    d.push((function (e) {
    ...
    })), t.wrapCallSite = S, t.getErrorSource = C, t.mapSourcePosition = b, t.retrieveSourceMap = w, t.install = function (e) {
        ...
        var i;
        (c || (c = "emptyCacheBetweenOperations" in e && e.emptyCacheBetweenOperations), s || (s = !0, Error.prepareStackTrace = x), a) || (!("handleUncaughtExceptions" in e) || e.handleUncaughtExceptions) && "object" == typeof process && null !== process && "function" == typeof process.on && (a = !0, i = process.emit, process.emit = function (e) {
    ...
    e.exports = function (e) {
        ...
        function b() {
            c && (c.removeListener("resize", y), c.removeListener("move", y), clearTimeout(l), c.removeListener("close", v), c.removeListener("closed", w), c = null)
        }
        try {
            a = o.readFileSync(f)
        } catch (e) {}
        return a && (h() || a.isMaximized || a.isFullScreen) ? h() && a.displayBounds && d() : a = null, a = Object.assign({
            ...
            unmanage: b,
            manage: function (e) {
                u.maximize && a.isMaximized && e.maximize(), u.fullScreen && a.isFullScreen && e.setFullScreen(!0), e.on("resize", y), e.on("move", y), e.on("close", v), e.on("closed", w), c = e
            },
    ...
    n.keys = function () {
        return []
    }, n.resolve = n, e.exports = n, n.id = 64
}, function (e, t) {
        ...
        return function (e, t) {
            ...
            for (s in (t = t || {}).up = t.up || !0, t.mid = t.mid || !0, t.down = t.down || !0, t.size = t.size || "maxi", e = e.split(""))
                if (!o(s)) {
                    ...
                    var c = ["up", "mid", "down"];
                    for (var l in c)
                        for (var u = c[l], f = 0; f <= r[u]; f++) t[u] && (a += n[u][i(n[u].length)])
                } return a
        }(e)
    }
}, function (e, t, n) {
    ...
    var r = n(3),
        ...
        p = t.File = function (e) {
            ...
            if (l.call(this, e), e.filename || e.dirname) n("filename or dirname", "stream"), this._basename = this.filename = e.filename ? i.basename(e.filename) : "winston.log", this.dirname = e.dirname || i.dirname(e.filename), this.options = e.options || {
                flags: "a"
                ...
                n("stream", "filename", "maxsize"), this._stream = e.stream, this._isStreams2 = u(this._stream), this._stream.on("error", (function (e) {
                    t.emit("error", e)
    ...
    o.inherits(p, l), p.prototype.name = "file", p.prototype.log = function (e, t, n, r) {
        if (this.silent) return r(null, !0);
        ...
        c.on("error", (function (e) {
            ...
            for (var n = (t = (o + t).split(/\n+/)).length - 1, r = 0; r < n; r++)(!e.start || a >= e.start) && l(t[r]), a++;
            o = t[n]
        })), c.on("close", (function () {
        ...
        this.opening = !0,
            function t(n) {
                ...
                function s(t) {
                    e._stream && (e._stream.end(), e._stream.destroySoon()), e._size = t, e.filename = n, e._stream = r.createWriteStream(o, e.options), e._isStreams2 = u(e._stream), e._stream.on("error", (function (t) {
    ...
    r.inherits(l, i.Transport), l.prototype.name = "http", l.prototype._request = function (e, t) {
    ...
    i.inherits(f, r.EventEmitter), f.prototype.configure = function (e) {
        ...
        if (a.length) {
            ...
            if (t.length - 1 - (h.length - p.length) > 0 || 1 === t.length) {
                ...
                l = "[object Object]" === d || "[object Error]" === d || "[object Array]" === d ? t.pop() : {}
            }
    ...
    function c(e, t, n, o) {
        if (!o.filter || o.filter(t, n)) return function (e, t, n, o) {
            ...
            if (s.isFile() || s.isCharacterDevice() || s.isBlockDevice()) return function (e, t, n, i, o) {
                return t === a ? l(e, n, i, o) : function (e, t, n, i) {
            ...
            if (s.isSymbolicLink()) return function (e, t, n, o) {
                ...
                if (e === a) return r.symlinkSync(s, n); {
                    ...
                    if (o.dereference && (e = i.resolve(process.cwd(), e)), f(s, e)) throw new Error(`Cannot copy '${s}' to a subdirectory of itself, '${e}'.`);
                    if (r.statSync(n).isDirectory() && f(e, s)) throw new Error(`Cannot overwrite '${e}' with '${s}'.`);
                    return function (e, t) {
    ...
    function h(e, t) {
        ...
        if (n.isDirectory() && f(e, t)) throw new Error(`Cannot copy '${e}' to a subdirectory of itself, '${t}'.`);
        return i
    }
    e.exports = function (e, t, n) {
        "function" == typeof n && (n = {
    ...
    e.exports = function e(t, n, a, c) {
        ...
        let l = n.mode;
        const u = n.fs || r;
        void 0 === l && (l = s & ~process.umask()), c || (c = null), a = a || function () {}, t = i.resolve(t), u.mkdir(t, l, r => {
    ...
    e.exports = function e(t, n, a) {
        ...
        void 0 === c && (c = s & ~process.umask()), a || (a = null), t = i.resolve(t);
        try {
    ...
    function h(e, t, n, o, s) {
        (o.dereference ? r.stat : r.lstat)(t, (a, l) => a ? s(a) : l.isDirectory() ? function (e, t, n, i, o, s) {
            if (t === c) return function (e, t, n, i, o) {
                r.mkdir(n, s => {
                    if (s) return o(s);
            ...
            return m(n, i, o, s)
        }(l, e, t, n, o, s) : l.isFile() || l.isCharacterDevice() || l.isBlockDevice() ? function (e, t, n, i, o, s) {
            return t === c ? p(e, n, i, o, s) : function (e, t, n, i, o) {
                if (!i.overwrite) return i.errorOnExist ? o(new Error(`'${n}' already exists`)) : o();
                r.unlink(n, r => r ? o(r) : p(e, t, n, i, o))
            }(e, n, i, o, s)
        }(l, e, t, n, o, s) : l.isSymbolicLink() ? function (e, t, n, o, s) {
            r.readlink(t, (t, a) => t ? s(t) : (o.dereference && (a = i.resolve(process.cwd(), a)), e === c ? r.symlink(a, n, s) : void r.readlink(n, (t, c) => t ? "EINVAL" === t.code || "UNKNOWN" === t.code ? r.symlink(a, n, s) : s(t) : (o.dereference && (c = i.resolve(process.cwd(), c)), y(a, c) ? s(new Error(`Cannot copy '${a}' to a subdirectory of itself, '${c}'.`)) : e.isDirectory() && y(c, a) ? s(new Error(`Cannot overwrite '${c}' with '${a}'.`)) : function (e, t, n) {
    ...
    function p(e, t, n, i, o) {
        return "function" == typeof r.copyFile ? r.copyFile(t, n, t => t ? o(t) : d(e, n, i, o)) : function (e, t, n, i, o) {
            const s = r.createReadStream(t);
            s.on("error", e => o(e)).once("open", () => {
                const t = r.createWriteStream(n, {
                    mode: e.mode
                });
                t.on("error", e => o(e)).on("open", () => s.pipe(t)).once("close", () => d(e, n, i, o))
            })
        }(e, t, n, i, o)
    }
    ...
    function c(e, t, n) {
        o(e), o(t), o("function" == typeof n), t.lstat(e, (r, i) => r && "ENOENT" === r.code ? n(null) : r && "EPERM" === r.code ? l(e, t, r, n) : i && i.isDirectory() ? f(e, t, r, n) : void t.unlink(e, r => {
            if (r) {
    ...
    e.exports = {
        createFile: r((function (e, t) {
            ...
            o.stat(e, (r, o) => {
                ...
                const c = i.dirname(e);
                a(c, (e, r) => e ? t(e) : r ? n() : void s.mkdirs(c, e => {
                    if (e) return t(e);
                    n()
                }))
            })
    ...
    e.exports = {
        createLink: r((function (e, t, n) {
            ...
            a(t, (c, l) => c ? n(c) : l ? n(null) : void o.lstat(e, o => {
    ...
    e.exports = {
        createSymlink: r((function (e, t, n, r) {
            r = "function" == typeof n ? n : r, n = "function" != typeof n && n, m(t, (s, c) => s ? r(s) : c ? r(null) : void u(e, t, (s, c) => {
                if (s) return r(s);
    ...
    const r = n(5).fromCallback,
        i = n(28);
    i.outputJson = r(n(102)), i.outputJsonSync = n(103), i.outputJSON = i.outputJson, i.outputJSONSync = i.outputJsonSync, i.writeJSON = i.writeJson, i.writeJSONSync = i.writeJsonSync, i.readJSON = i.readJson, i.readJSONSync = i.readJsonSync, e.exports = i
}, function (e, t, n) {
    var r = n(3),
        i = n(100),
        o = n(101),
    ...
    function f(e) {
        ...
        var l = e.ReadStream;
        d.prototype = Object.create(l.prototype), d.prototype.open = function () {
            var e = this;
        ...
        function d(e, t) {
            return this instanceof d ? (l.apply(this, arguments), this) : d.apply(Object.create(d.prototype), arguments)
        }
    ...
    }), e.exports.closeSync = r.closeSync = (l = r.closeSync, function (e) {
    ...
    process.chdir = function (e) {
        ...
        e.chown = f(e.chown), e.fchown = f(e.fchown), e.lchown = f(e.lchown), e.chmod = l(e.chmod), e.fchmod = l(e.fchmod), e.lchmod = l(e.lchmod), e.chownSync = h(e.chownSync), e.fchownSync = h(e.fchownSync), e.lchownSync = h(e.lchownSync), e.chmodSync = u(e.chmodSync), e.fchmodSync = u(e.fchmodSync), e.lchmodSync = u(e.lchmodSync), e.stat = p(e.stat), e.fstat = p(e.fstat), e.lstat = p(e.lstat), e.statSync = d(e.statSync), e.fstatSync = d(e.fstatSync), e.lstatSync = d(e.lstatSync), e.lchmod || (e.lchmod = function (e, t, n) {
            n && process.nextTick(n)
        }, e.lchmodSync = function () {});
        e.lchown || (e.lchown = function (e, t, n, r) {
            r && process.nextTick(r)
        ...
        e.read = (r = e.read, function (t, n, i, o, s, a) {
            ...
            if (a && "function" == typeof a) {
                var l = 0;
                c = function (u, f, h) {
                    if (u && "EAGAIN" === u.code && l < 10) return l++, r.call(e, t, n, i, o, s, c);
                    a.apply(this, arguments)
                }
            }
    ...
    e.exports = function (e, t, n, a) {
        ...
        const c = r.dirname(e);
        o(c, (r, o) => r ? a(r) : o ? s.writeJson(e, t, n, a) : void i.mkdirs(c, r => {
            if (r) return a(r);
            s.writeJson(e, t, n, a)
        }))
    }
            ...
            a(i.dirname(n)),
                function () {
                    if (c) try {
                        ...
                        if ("EXDEV" === e.code || "EISDIR" === e.code || "EPERM" === e.code || "ENOTSUP" === e.code) return l(t, n, c);
                        throw e
                    }
                }()
        }
        ...
        move: r((function (e, t, n, r) {
            ...
            i.stat(e, (n, i) => n ? r(n) : i.isDirectory() && function (e, t) {
                const n = e.split(o.sep),
                    r = t.split(o.sep);
                return n.reduce((e, t, n) => e && r[n] === t, !0)
            }(e, t) ? r(new Error(`Cannot move '${e}' to a subdirectory of itself, '${t}'.`)) : void c(o.dirname(t), n => n ? r(n) : function (e, t, n, r) {
                if (n) return a(t, i => i ? r(i) : u(e, t, n, r));
                l(t, (i, o) => i ? r(i) : o ? r(new Error("dest already exists.")) : u(e, t, n, r))
            }(e, t, s, r)))
        }))
    }
}, function (e, t, n) {
    ...
    o.inherits(d, a), u.transports.DailyRotateFile = d, d.prototype.name = "dailyRotateFile", d.prototype.log = function (e, t, n, r) {
        if (this.silent) return r(null, !0);
        if (this._failures >= this.maxRetries) return r(new Error("Transport is in a failed state."));
        var i = this,
            o = s.log({
    ...
    t.SourceMapGenerator = n(43).SourceMapGenerator, t.SourceMapConsumer = n(111).SourceMapConsumer, t.SourceNode = n(114).SourceNode
}, function (e, t) {
    ...
    function l(e) {
        ...
        })), this._names = o.fromArray(s.map(String), !0), this._sources = o.fromArray(i, !0), this.sourceRoot = a, this.sourcesContent = c, this._mappings = l, this.file = u
    }
    ...
    c.fromSourceMap = function (e) {
        ...
        return o
    }, t.SourceMapConsumer = c, l.prototype = Object.create(c.prototype), l.prototype.consumer = c, l.fromSourceMap = function (e) {
        ...
        for (var n, i, o, c, l, f = 1, h = 0, p = 0, d = 0, m = 0, g = 0, y = e.length, v = 0, w = {}, b = {}, _ = [], E = []; v < y;)
            if (";" === e.charAt(v)) f++, v++, h = 0;
            else if ("," === e.charAt(v)) v++;
        else {
            for ((n = new u).generatedLine = f, c = v; c < y && !this._charIsMappingSeparator(e, c); c++);
            if (o = w[i = e.slice(v, c)]) v += i.length;
            else {
                for (o = []; v < c;) s.decode(e, v, b), l = b.value, v = b.rest, o.push(l);
            ...
            n.generatedColumn = h + o[0], h = n.generatedColumn, o.length > 1 && (n.source = m + o[1], m += o[1], n.originalLine = p + o[2], p = n.originalLine, n.originalLine += 1, n.originalColumn = d + o[3], d = n.originalColumn, o.length > 4 && (n.name = g + o[4], g += o[4])), E.push(n), "number" == typeof n.originalLine && _.push(n)
        }
        a(E, r.compareByGeneratedPositionsDeflated), this.__generatedMappings = E, a(_, r.compareByOriginalPositions), this.__originalMappings = _
    ...
    }, t.BasicSourceMapConsumer = l, f.prototype = Object.create(c.prototype), f.prototype.constructor = c, f.prototype._version = 3, Object.defineProperty(f.prototype, "sources", {
        get: function () {
    ...
    t.GREATEST_LOWER_BOUND = 1, t.LEAST_UPPER_BOUND = 2, t.search = function (e, n, r, i) {
        ...
        var o = function e(n, r, i, o, s, a) {
            var c = Math.floor((r - n) / 2) + n,
                l = s(i, o[c], !0);
            return 0 === l ? c : l > 0 ? r - c > 1 ? e(c, r, i, o, s, a) : a == t.LEAST_UPPER_BOUND ? r < o.length ? r : -1 : c : c - n > 1 ? e(n, c, i, o, s, a) : a == t.LEAST_UPPER_BOUND ? c : n < 0 ? -1 : n
    ...
    a.fromStringWithSourceMap = function (e, t, n) {
        ...
        return t.eachMapping((function (e) {
            ...
            h = e
        }), this), c < s.length && (h && p(h, l()), r.add(s.splice(c).join(""))), t.sources.forEach((function (e) {
        ...
        return this.walk((function (e, r) {
            ...
            for (var l = 0, u = e.length; l < u; l++) 10 === e.charCodeAt(l) ? (t.line++, t.column = 0, l + 1 === u ? (o = null, i = !1) : i && n.addMapping({
                source: r.source,
                original: {
                    line: r.line,
                    column: r.column
    ...
    (function () {
        ...
        t = null, e.exports = function () {
            ...
            if (null == t && (t = n(29)), !t.isDisposable(e)) throw new TypeError("Arguments to CompositeDisposable.add must have a .dispose() method")
        }
    }).call(this)
}, function (e, t, n) {
    "use strict";
    ...
    function _(e) {
        let t = y.get(e);
        return t || ((e.stack || "").toString(), t = y.get(e)), t ? v(e, t) : e.stack
    }
    ...
    function A(e) {
        ...
        switch (c) {
            ...
            case "submenu":
                return {
                    id: t, type: "submenuItem", label: i, enabled: n, visible: r, menu: N(e.submenu, t), accessKey: a
                };
            case "checkbox":
                return {
    ...
    function q() {
        for (const t of Object($.enumerateValues)($.HKEY.HKEY_CURRENT_USER, "Environment"))
            if ("Path" === t.name && ((e = t).type === $.RegistryValueType.REG_SZ || e.type === $.RegistryValueType.REG_EXPAND_SZ)) return t.data.split(";").filter(e => e.length > 0);
        var e;
    ...
    function ce() {
        const e = x.Menu.buildFromTemplate([{
            role: "editMenu"
        }]).items[0];
        return (e && e.submenu ? e.submenu.items : []).filter(e => !ae(e.role, "pasteandmatchstyle"))
    }
    ...
    function le(e, t) {
        return function e(t, n, r = []) {
            ...
            for (const [o, s] of t.entries())
                if (ae(s.role, "editmenu"))
                    for (const e of ce()) i.append(e);
                else {
                    const t = [...r, o];
                    i.append(new x.MenuItem({
                        label: s.label,
                        type: s.type,
                        enabled: s.enabled,
                        role: s.role,
